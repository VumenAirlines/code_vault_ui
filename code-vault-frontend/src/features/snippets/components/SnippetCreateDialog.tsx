          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 pt-4">
            <FormField name="title" control={form.control} render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input placeholder="e.g., React Fetch Hook" {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />
            ...
            <FormField name="language" control={form.control} render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input placeholder="e.g., typescript" {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />
            ...
            <FormField name="description" control={form.control} render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input placeholder="A short description." {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />

            <div className="pt-4">
              <Button type="submit" disabled={snippetCreateMutation.isPending} className="w-full">
                {snippetCreateMutation.isPending ? 'Creating...' : 'Continue to Editor'}
              </Button>
            </div>
          </form>
        </Form>
